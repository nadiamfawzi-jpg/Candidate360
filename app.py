...
with st.sidebar:
    ...
    # Keep multilingual transcription enabled without showing a language
    # selector in the sidebar. Whisper/Groq detects the spoken language.
...
with delivery_tab:
    ...
    if media_file is not None:
        ...
        if is_video_file:
            ...
            uploaded_video_fingerprint = hashlib.sha256(
                media_file.getvalue()
            ).hexdigest()
            if (
